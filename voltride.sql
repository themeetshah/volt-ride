...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 23, 2025 at 08:13 AM
...
CREATE TABLE `ride` (
  ...
  `distance` decimal(10,0) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `ride` (`r-id`, `user-id`, `v-id`, `time`, `date`, `status`, `payment`, `profit`, `distance`) VALUES
(1, 2, 1, '10:00:00', '2025-03-20', 'Completed', 100, 20, 10),
(2, 2, 2, '12:30:00', '2025-03-21', 'Completed', 150, 30, 22),
(26, 2, 1, '19:04:23', '2025-03-22', 'ongoing', 83, 17, 52),
(27, 2, 3, '11:58:50', '2025-03-23', 'ongoing', 0, 0, 0);
...
(2, 'user', 'Coder', 'Shah', 'codergirgit@gmail.com', 9876543210, '12345', 'Bombay.jpg', '213654', 'pending');
...
(1, 'GJ01RL1111', 'VoltRide X1', 90, 1, 'Available'),
(2, 'GJ02CD5678', 'EV-Two', 51, 1, 'Occupied'),
(3, 'GJ03EF9101', 'EV-Three', 100, 1, 'in-use');
...
--
ALTER TABLE `ride`
  MODIFY `r-id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
