...
(2, 2, 2, '12:30:00', '2025-03-21', 'Completed', 150, 50),
(9, 2, 3, '22:55:35', '2025-03-22', 'ongoing', 0, 0);
...
(2, 'user', 'acs', 'ascd', 'codergirgit@gmail.com', 9876543210, '12345', 'Bombay.jpg', '213654', 'pending');
...
--
ALTER TABLE `ride`
  MODIFY `r-id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
